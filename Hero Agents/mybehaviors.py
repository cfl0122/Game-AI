...
def treeSpec(agent):
	...
	# spec = None
	spec = [(Selector, "rootSelect"),(Retreat,0.45, "retreat") , [(HitpointDaemon, 0.45, "HitpointDaemon"), [(Selector,"SecondSelect"), [(BuffDaemon,3, "BuffDaemon"),[(Sequence,"Hero Sequence"), (ChaseHero, "ChaseHero"), (KillHero, "KillHero")]], [(Sequence,"ChaseMinionSequence"), (ChaseMinion, "ChaseMinion"), (KillMinion, "KillMinion")] ]]]
